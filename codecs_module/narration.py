...
class NarrationDecoder:
    """Decodes workspace slot vectors into a short diagnostic text via a
    shared, frozen LM.

    This is a shorter version of `SlotDecoder.decode`, intended as a
    diagnostic narration of the current workspace state rather than a task
    answer. It shares the model and tokenizer with `LatentLoop` and
    `SlotDecoder`, reads the workspace's slots, and does not mutate the
    workspace.
    """
