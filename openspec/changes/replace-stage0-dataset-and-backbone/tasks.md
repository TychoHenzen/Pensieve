...
- [ ] 1.2 Implement the shared Stage 0 identity and official Qwen math-prompt module, replacing duplicated Stage 0 constants without changing runtime entry points yet.
